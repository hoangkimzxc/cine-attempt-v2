...
export const tmdb_requests = {
  ...
  fetchDocumentaryMovies: `/discover/movie?api_key=${TMDB_API_KEY}&with_genres=99`,
  fetchFantasyMovies: `/discover/movie?api_key=${TMDB_API_KEY}&with_genres=14`,
  fetchNewsTV: `/discover/tv?api_key=${TMDB_API_KEY}&with_genres=10763`,
  fetchFamilyTV: `/discover/tv?api_key=${TMDB_API_KEY}&with_genres=10751`,
  fetchKidsTV: `/discover/tv?api_key=${TMDB_API_KEY}&with_genres=10762`,
  fetchMysteryTV: `/discover/tv?api_key=${TMDB_API_KEY}&with_genres=9648`,
  fetchRealityTV: `/discover/tv?api_key=${TMDB_API_KEY}&with_genres=10764`,
  fetchTalkTV: `/discover/tv?api_key=${TMDB_API_KEY}&with_genres=10767`,
  searchMovies: `https://api.themoviedb.org/3/search/movie?api_key=${TMDB_API_KEY}`,
};
